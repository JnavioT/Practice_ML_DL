...
if __name__ == "__main__":
    ...
    for fold_ in range(5):
        run(fold_)
    #run code: python -W ignore ohe_log_reg.py
    # Fold = 0, AUC = 0.7869756331076062
    # Fold = 1, AUC = 0.7871030109242154
    # Fold = 2, AUC = 0.785912618742864
    # Fold = 3, AUC = 0.7863937896433988
    # Fold = 4, AUC = 0.7846195566930034